...
import { addPastor } from "@/actions/actions";
import { Toaster } from "@/components/Toaster/Toaster";
import { useToaster } from "@/providers/ToasterContext";

export const AddPastor = ({ setAddPastor,setGP }) => {
  ...
  useEffect(() => {
    ...
    const sendD = async () => {
      ...
      const response = await addPastor(data);
      if (response.status) {
    ...
    <div className={`${styles.container} pt-10`}>
      <div className="w-full max-w-xl mx-auto bg-white rounded shadow p-10">
        <div className="flex justify-between mb-3">
          <h1 className="font-semibold">Add Pastor</h1>
          <FontAwesomeIcon
            icon={faXmark}
            onClick={() => setAddPastor(false)}
