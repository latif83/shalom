...
import { addPastor, editMember, editPastor } from "@/actions/actions";
import { Toaster } from "@/components/Toaster/Toaster";
import { useToaster } from "@/providers/ToasterContext";

export const EditMember = ({ setEditMember, setGM, memberDetails }) => {
  ...
  useEffect(() => {
    ...
    setFname(memberDetails.f_name);
    setLName(memberDetails.l_name);
    setTitle(memberDetails.title);
    setEmail(memberDetails.email);
    setAddress(memberDetails.address);
    setMobile(memberDetails.contact);
    ...
    const sendD = async () => {
      ...
      const response = await editMember(data);
      if (response.status) {
